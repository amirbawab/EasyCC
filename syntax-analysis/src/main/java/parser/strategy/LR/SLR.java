...
import parser.strategy.LR.data.LRData;
import parser.strategy.LR.exceptions.SLRException;
...
import parser.strategy.LR.structure.table.LRTable;
import parser.strategy.LR.structure.table.cell.*;
import token.*;
