...
public class LLData {
    ...
    private List<LLDataEntry> entryList;
    ...
    public void addFineEntry(Stack<AbstractSyntaxToken> stackSyntax, AbstractToken lexicalToken, NonTerminalToken productionLHS, List<AbstractSyntaxToken> productionRHS) {
        ...
        // Create entry
        LLDataFineEntry fineEntry = new LLDataFineEntry(entryList.size()+1, stackList, lexicalToken, productionLHS, productionRHS, derivationClone);
        l.debug(fineEntry);
    ...
    public void addErrorEntry(Stack<AbstractSyntaxToken> stackSyntax, AbstractToken lexicalToken, String message) {
        ...
        // Create entry
        LLDataErrorEntry errorEntry = new LLDataErrorEntry(entryList.size()+1, stackList, lexicalToken, message);
        l.debug(errorEntry);
     ...
     * @return entry list
     */
    public List<LLDataEntry> getEntryList() {
        return entryList;
    }
